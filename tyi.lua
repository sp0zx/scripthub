...
rbxname = "YouAintDumb"
local prefix = "!"
local LPlayer = game.Players.YouAintDumb -- your name on my name (maxbrh1)
messageLL = "yeah yeah!" 
...
game:GetService("ReplicatedStorage"):WaitForChild("MainEvent"):FireServer(unpack(args))
		...
		if cmd == "fling" then
game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(0, 999999999999, 0)
			power = 99999999
        end
		if cmd == "kick" then
		    game:GetService("Players").LocalPlayer:Kick('you have gotten kicked')
    end
        if cmd == "grave" then
...
game.Players.LocalPlayer.Character.Head.Anchored = false
        ...
        if cmd == "ban" then
            game:GetService("Players").LocalPlayer:Kick('the mod team has BANNED you!')
